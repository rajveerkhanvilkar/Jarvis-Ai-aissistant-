...
cursor.execute(query)
query = "CREATE TABLE IF NOT EXISTS knowledge_base(id integer primary key, question VARCHAR(1000), answer VARCHAR(1000))"
cursor.execute(query)

query = "INSERT INTO knowledge_base VALUES (null,'what is your name', 'My name is Jarvis')"
cursor.execute(query)
query = "INSERT INTO knowledge_base VALUES (null,'who are you', 'I am Jarvis, a voice assistant')"
cursor.execute(query)
conn.commit()
